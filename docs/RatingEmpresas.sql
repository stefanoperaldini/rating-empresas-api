...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`cities` (
  ...
  `region_id` CHAR(2) CHARACTER SET 'utf8' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`sectors` (
  `id` CHAR(36) CHARACTER SET 'utf8' NOT NULL,
  `sector` VARCHAR(45) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`users` (
  ...
  `linkedin` VARCHAR(255) CHARACTER SET 'utf8' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`companies` (
  ...
  `sector_id` VARCHAR(36) CHARACTER SET 'utf8' NOT NULL,
  `url_web` VARCHAR(255) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `linkedin` VARCHAR(255) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `address` VARCHAR(60) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `sede_id` CHAR(36) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `url_logo` VARCHAR(255) CHARACTER SET 'utf8' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`companies_cities` (
  ...
  `company_id` VARCHAR(36) CHARACTER SET 'utf8' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `EnterpriseRanking`.`reviews` (
  ...
  `position_id` VARCHAR(36) CHARACTER SET 'utf8' NOT NULL,
  `start_year` DATE NOT NULL,
  `end_year` DATE NULL DEFAULT NULL,
  `salary` DECIMAL(10,0) NOT NULL,
  `inhouse_training` CHAR(1) CHARACTER SET 'utf8' NOT NULL,
  `growth_opportunities` CHAR(1) CHARACTER SET 'utf8' NOT NULL,
  `work_enviroment` CHAR(1) CHARACTER SET 'utf8' NOT NULL,
  `personal_life` CHAR(1) CHARACTER SET 'utf8' NOT NULL,
  `company_culture` CHAR(1) CHARACTER SET 'utf8' NOT NULL,
  `comment_title` VARCHAR(30) CHARACTER SET 'utf8' NOT NULL,
  `comment` VARCHAR(1000) CHARACTER SET 'utf8' NOT NULL,
  `created_at` DATETIME NOT NULL,
  `deleted_at` DATETIME NULL DEFAULT NULL,
  `city_id` CHAR(3) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `company_id` VARCHAR(36) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
